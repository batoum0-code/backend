...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    fakePrice: Attribute.BigInteger;
    image: Attribute.Media;
    images: Attribute.Media;
    color: Attribute.String;
    size1: Attribute.BigInteger;
    size2: Attribute.BigInteger;
    size3: Attribute.BigInteger;
    size4: Attribute.BigInteger;
    size5: Attribute.BigInteger;
    size6: Attribute.BigInteger;
